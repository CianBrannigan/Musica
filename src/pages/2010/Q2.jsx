...
import sound from './songs/sunflower-cut.mp3'
          ...
          <Row className="text-center">
            <Col>
              <Button style={{height: "5rem", width: "30rem", color: "black", background: "red" }} active>
                <h3>"Every Teardrop Is a Waterfall" by Coldplay</h3>
              </Button>
            </Col>
            <Col>
              <Button style={{height: "5rem", width: "30rem", color: "black", background: "orange" }} active> 
                <h3>"Palace" by A$AP Rocky</h3>
              </Button>
            </Col>
          </Row>
        </Card.Body>
