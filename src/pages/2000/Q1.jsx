  ...
  <Container className="text-center">
    ...
    <Row>
      <Card style={{width: "100rem", color: "white", background: "#eb0ea8" }}>
        <br></br>
        <Card.Img variant="top" src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/87/American_Idol_logo.svg/1200px-American_Idol_logo.svg.png" />
        <Card.Body>
          <Card.Title className="text-center"><h1>What famous Artist was the first person to win American Idol in 2002?</h1></Card.Title>
