...
import sound from './songs/dancingqueen-cut.mp3'
  ...
  <Container className="text-center">
    ...
    <Row>
      <Card style={{width: "100rem", color: "white", background: "#eb0ea8" }}>
        <br></br>
        <Card.Img variant="top" src="https://school-learningzone.co.uk/_images/1108151_l.jpg" />
        <Card.Body>
          ...
          <Row className="text-center">
            <Col>
              <Button style={{height: "5rem", width: "30rem", color: "black", background: "red" }} active>
                <h3>"Dancing Queen" by 	ABBA</h3>
              </Button>
            </Col>
            <Col>
              <Button style={{height: "5rem", width: "30rem", color: "black", background: "orange" }} active> 
                <h5>"You're The One That I Want" by Olivia Newton and John Travolta</h5>
              </Button>
            </Col>
          </Row>
        </Card.Body>
