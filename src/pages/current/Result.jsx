...
<div class="CRES">
  <Container>
    <br></br>
    <br></br>
    <h1 style={{ color: "white", fontWeight: "bold"}} className="text-center">YOUR RESULTS ARE</h1>
    <div>
      <br></br>
      <br></br>
      <ProgressBar  style={ { height: "5rem" } }>
        <ProgressBar striped variant="success" now={100} key={1} />
        <ProgressBar striped variant="danger" now={0} key={2} />
      </ProgressBar>
      <br></br>
      <br></br>
    </div>

    <h1 style={{ color: "white", fontWeight: "bold"}} className="text-center">YOU GOT 6 OUT OF 6 RIGHT!</h1>
    <br></br>
    <br></br>
