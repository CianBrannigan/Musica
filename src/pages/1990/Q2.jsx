...
import sound from './songs/teenspirit-cut.mp3'
          ...
          <Row className="text-center">
            <Col>
              <Button style={{height: "5rem", width: "30rem", color: "black", background: "green" }} active>
                <h3>"Smells like teen spirit" by Nirvana</h3>
              </Button>
            </Col>
            <Col>
              <Button style={{height: "5rem", width: "30rem", color: "black", background: "blue" }} active>
                <h3>"If It Makes You Happy" by Sheryl Crow</h3>
              </Button>
            </Col>
          </Row>
          <br></br>
