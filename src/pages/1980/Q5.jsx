  ...
  <Container className="text-center">
    ...
    <Row>
      <Card style={{width: "100rem", color: "white", background: "#eb0ea8" }}>
        ...
        <Card.Body>
          <Card.Title className="text-center"><h1>Which iconic Simple Minds song plays during the opening and 
            closing credits of The Breakfast Club</h1></Card.Title>
          <Row className="text-center">
            <Col>
              <Button style={{height: "5rem", width: "30rem", color: "black", background: "green" }} active>
                <h3>"dirty old town"</h3>
              </Button>
            </Col>
            <Col>
